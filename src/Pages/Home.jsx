        ...
        <section className="min-h-screen text-gray-200 dark:text-gray-200 flex flex-col justify-center px-6 md:px-16">
            <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
                ...
                <div className="flex-1 space-y-4 text-center md:text-left">
                    ...
                    <h2 className="text-xl text-blue-400 font-medium cursor-pointer transition-all duration-300 hover:text-blue-600 hover:translate-y-1 hover:scale-105">
                        Frontend Developer
                    </h2>
                    ...
                    <p className="text-gray-400 leading-relaxed max-w-lg">
                        Transforming Ideas into Digital Reality. Let's Build Success Together!
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center sm:justify-start mt-8 gap-4 sm:gap-6">
                        <Link
                            to="/about"
                            className="rounded-lg bg-linear-to-bl from-red-500 to-blue-500 text-white font-medium py-2 px-6 transition-all duration-300 hover:-translate-y-1 hover:brightness-90"
                        >
                            Explore Now
                        </Link>
                        ...
                        <Link
                            ...
                            className="rounded-lg border border-gray-300 bg-white dark:bg-black text-black dark:text-white 
                                    font-medium px-10 py-2 transition-all duration-300 
                ...
                <div className="flex-1 flex justify-center">
                    <img
                        ...
                        loading="lazy"
                        className="w-60 h-60 md:w-72 md:h-72 object-contain cursor-pointer transition-transform duration-300 hover:scale-105 hover:rotate-1 hover:shadow-lg"
                    />
                </div>
